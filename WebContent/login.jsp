...
<body>
	<div class="container-fluid container-center card-effect">
		<div class="container-lg shadow mt-5 mx-auto p-3 rounded-2">
			<div class="row p-5">
				<div class="col-lg-6 col-md-5 col-sm-10 mt-5 img-mt">
				...
				<div class="col-lg-5 col-md-5 col-sm-10 mx-auto mt-5">
					...
					<form>
						...
						<div class="row mb-4">
							<label class="text-right cursor-pointer"> <b> Forget
									Password! </b>
							</label>
						</div>
		...
		<div class="container-lg shadow mt-5 mx-auto p-3 rounded-2 card-back">
